        ...
        <div className='md:w-[80%] md:mx-auto px-5 p-5'>
            ...
            <div className='grid grid-cols-1 gap-3'>
                <div className='border-2 rounded-md p-4'>
                    <h3 className='text-1xl font-semibold py-3'>When should you use context API?</h3>
                ...
                <div className='border-2 rounded-md p-4'>
                    <h3 className='text-1xl font-semibold py-3'>What is custom hook?</h3>
                ...
                <div className='border-2 rounded-md p-4'>
                    <h3 className='text-1xl font-semibold py-3'>What is useRef?</h3>
                    <p>Answer: useRef is used to create a reference object</p>
                </div>
                <div className='border-2 rounded-md p-4'>
                    <h3 className='text-1xl font-semibold py-3'>What is useMemo?</h3>
